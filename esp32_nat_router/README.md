...
> ⚠️ **Configuração Local (ProxyMedia)**
> 
> Este firmware está configurado para:
> - **Rede Principal (Uplink):** HOME
> - **Access Point:** SmartThings (192.168.4.1)
> - **Senha AP:** smart12345
> 
...
> **Comandos úteis:**
> ```
> show status      # Ver status da conexão
> show config      # Ver configuração atual
> set_sta <SSID> <SENHA>   # Configurar rede principal
> set_ap <SSID> <SENHA>    # Configurar Access Point
